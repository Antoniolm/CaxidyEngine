...
void InventoryMenuGame::setInventory(const vector<Equipment*> & equipVec, const vector<vec2f> & posVec){
...
bool InventoryMenuGame::addEquip(Equipment * aEquip){
    bool result=false;
...
Inventory * InventoryMenuGame::getInventory(){
    return inventory;
}

//**********************************************************************//

void InventoryMenuGame::clearInventory(){
...
Equipment * InventoryMenuGame::getEquippetItem(int aType){
    Equipment * result=0;
...
void InventoryMenuGame::initInfoItem(){
...
void InventoryMenuGame::changeSelectedItems(){
...
NodeSceneGraph * InventoryMenuGame::createMatrixItems(){
    //////////////////////////////////
